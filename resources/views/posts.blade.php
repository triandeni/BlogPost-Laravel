...
<div class="card mb-3">
  ...
  @endif
    ...
    <div class="card-body text-center">
      ...
      <p> By : <a href="/posts?author={{ $posts[0]->author->username }}" class="text-decoration-none"> {{ $posts[0]->author->name }} </a> in  <a href="/posts?category={{ $posts[0]->category->slug }}" class="text-decoration-none"> {{ $posts[0]->category->name }}</p></a>
      <p class="card-text"><small class="text-muted">create at : {{ $posts[0]->created_at->diffForhumans() }}
    </small>
</p>
  ...
  @else
  <p class="text-center fs-4"> No Found Posts</p>
  @endif
